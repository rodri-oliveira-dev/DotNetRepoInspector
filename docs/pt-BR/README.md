...
- [`container.md`](container.md) — distribuição oficial via GHCR/Docker Hub, política de tags/digest, evidências de SBOM/provenance, build local, mounts endurecidos, execução non-root e uso offline.
